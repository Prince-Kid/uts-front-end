  ...
  resources: {
    ENG: {
      translation: {
        ...
        Welcome:
          "At UTS, we are passionate about redefining fashion and design. Founded by Umurage Twizerimana Schadrack, our company is dedicated to creating innovative, stylish, and high-quality fashion solutions for every occasion. Explore our latest designs, where creativity meets craftsmanship, and discover the future of fashion with UTS Business Ltd.",
        AboutUs:
          "At UTS Business Ltd, we are committed to redefining fashion with innovation and style. Founded by Umurage Twizerimana Schadrack, our mission is to offer high-quality, creative, and sustainable fashion solutions for every occasion. We blend modern design with ethical practices, ensuring that every piece reflects craftsmanship and responsibility. Discover the future of fashion with UTS.",
        ...
        about1:
          "At UTS Business Ltd, founded by Umurage Twizerimana Schadrack, we are at the forefront of redefining fashion and design. Our mission is to create innovative, stylish, and high-quality fashion solutions that cater to diverse occasions and individual expressions. We believe that fashion is not just about clothing; it is a powerful means of self-expression and cultural identity",
        about2:
          "Through our carefully crafted designs, we aim to inspire confidence and creativity in our customers. We are committed to sustainable practices, ensuring that our materials are ethically sourced and environmentally friendly. Our dedication extends beyond fashion; we actively support local artisans and communities, helping them thrive through partnerships that uplift and empower",
        Links: "Links",
        Home: "Home",
        Products: "Products",
        "About Us": "About Us",
    ...
    KINY: {
      translation: {
        ...
        Welcome:
          "UTS ni sosiyete ifite impano mu guhindura imiterere n’imyambarire. Yashinzwe na  Twizerimana Schadrack, kandi ikaba yiyemeje gukora ibisubizo by’imyambarire bigezweho, bifite umwimerere, kandi byujuje ubuziranenge ku bwoko bwose bw’ibirori. Menya ibishya mu mitako yacu, aho ubuhanga buhurira n’ubunyamwuga, kandi wiyumvemo ejo hazaza h’imyambarire hamwe na UTS Business Ltd.",
        about1:
          "Muri UTS Business Ltd, yashinzwe na Umurage Twizerimana Schadrack, turi ku isonga mu guhindura imideli n'ubugeni. Intego yacu ni ugutanga ibisubizo bigezweho, byiza kandi bifite ireme mu bijyanye n’imideli, bigamije guhuza ibihe bitandukanye n'uburyo bwihariye bwo kwiyerekana. Twemera ko imideli itari ugukwear gusa; ahubwo ni uburyo bukomeye bwo kugaragaza umuntu ku giti cye no kwerekana umuco.",
        about2:
          "Binjiye mu gitekerezo cyacu cy'ibishushanyo byateguwe neza, twiyemeje gushishikariza abakiriya bacu kugira ikizere no kugaragaza ubuhanzi. Turi abizerwa mu buryo burambye, tubahiriza ko ibikoresho dukoresha biba byarakuwe mu buryo bwiza kandi bwita ku bidukikije. Kwiyemeza kwacu ntigusiga imideli gusa; dushyigikira kandi abahanzi b'ingeri zose n'imiryango, tubafasha kwiteza imbere binyuze mu bufatanye butuma bagira iterambere.",
    ...
    SW: {
      translation: {
        Login: "Ingia",
        "Sign Up": "Jisajili",
        "Enter your credentials": "Weka maelezo yako ya kuingia",
        ...
        "Not Registered yet?": "Hujajisajili bado?",
        ...
        Welcome:
          "Karibu kwenye duka letu la mtandaoni! Iwe wewe ni mnunuzi unayetafuta ofa nzuri au muuzaji anayetaka kuonyesha bidhaa zake, jukwaa letu linakupa fursa ya kuunganishwa na kufanikiwa. Chunguza anuwai ya bidhaa zetu na unda akaunti ",
        AboutUs:
          "Karibu Crafters, jukwaa la biashara mtandaoni lililoundwa kwa ajili ya kusaidia SMEs, mafundi na wajasiriamali wadogo nchini Rwanda. Lengo letu ni kuwaunganisha mafundi wenye vipaji na wanunuzi kwa kutoa soko salama na rahisi ambapo ubunifu hukutana na biashara. Crafters hufanya mchakato wa kuuza mtandaoni uwe rahisi kwa kutumia usajili rahisi, usimamizi wa bidhaa, ufuatiliaji wa maagizo, na mfumo wa mawasiliano kati ya wanunuzi na wauzaji. Tunajitahidi kuunda jamii yenye nguvu ambapo wanunuzi hugundua bidhaa za kipekee na wauzaji hukua kwa ujasiri.",
        "Get In Touch With Us": "Wasiliana Nasi",
        "We Are Here To Help": "Tuko Hapa Kukusaidia",
        "If you have an urgent business concern please contact us at":
          "Ikiwa una tatizo la haraka la biashara tafadhali wasiliana nasi kupitia",
        "Send Us Message": "Tuma Ujumbe",
        "Your Name": "Jina Lako",
        "Your Email": "Barua Pepe Yako",
        "Your Message": "Ujumbe Wako",
        "Send Message": "Tuma Ujumbe",
        abouts:
          "Crafters imejitolea kutoa bidhaa bora na huduma nzuri kwa wateja wetu. Tunajitahidi kuleta bidhaa za kipekee na bunifu zinazoboreshwa mtindo wa maisha yako.",
        Links: "Viunganishi",
        Home: "Nyumbani",
        Products: "Bidhaa",
        ...
        Email: "Barua Pepe",
        "© 2024 Upscale Crafters, all rights reserved":
          "© 2024 Upscale Crafters, haki zote zimehifadhiwa",
        ...
        "DASHBOARD PAGE": "UKURASA WA DASHIBODI",
        Administrator: "Msimamizi",
        sellers: "wauzaji",
        Transactions: "Miamala",
        Orders: "Maagizo",
        IncomeExpense: "MapatoMatumizi",
        "Buyers 40": "Wanunuzi 40",
        "Sellers 30": "Wauzaji 30",
        "View all": "Tazama yote",
        Name: "Jina",
        Action: "Kitendo",
        "Requested To Be A Vendor": "Ombi La Kuwa Muuzaji",
        ...
        Cars: "Magari",
        Shoes: "Viatu",
        "POPULAR PRODUCTS": "BIDHAA ZINAZOTAFUTWA ZAIDI",
        ABOUT: "Kuhusu",
        "Best Deals": "Ofa Bora",
        stock: "Stock",
        "IN STOCK": "Katika Hisa",
        Description: "Maelezo",
        "No description available": "Hakuna maelezo yaliyopo",
        Quantity: "Kiasi",
        Size: "Ukubwa",
        "Leave my review": "Acha maoni yangu",
        "Show More": "Onyesha Zaidi",
        "Show Less": "Onyesha Chache",
        "Error fetching order details": "Hitilafu ya kupakua maelezo ya agizo",
        "No order details available": "Hakuna maelezo ya agizo yaliyopo",
        "Delivery Address": "Anwani ya Uwasilishaji",
        Order: "Agizo",
        "Placed On": "Imewekwa Mnamo",
        "Expected Delivery Date": "Tarehe ya Uwasilishaji Inayotarajiwa",
        "No product found": "Hakuna bidhaa iliyopatikana",
        "Order Details": "Maelezo ya Agizo",
        Product: "Bidhaa",
        Price: "Bei",
        "Update to": "Sasisha kuwa",
        "Order Completed": "Agizo Limekamilika",
        "Check Your gmail inbox": "Angalia kisanduku chako cha Gmail",
        Review: "Mapitio",
        Reviews: "Mapitio",
